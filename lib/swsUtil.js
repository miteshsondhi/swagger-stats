...
module.exports.swsParameterProperties = {
  ...
  required: 'required', // We will not be copying schema for "body" parameters
...
module.exports.swsMetrics = {
  ...
  nodejs_process_memory_heap_total_bytes: {
    name: 'nodejs_process_memory_heap_total_bytes',
    type: 'gauge',
  ...
  nodejs_process_memory_external_bytes: {
    name: 'nodejs_process_memory_external_bytes',
    type: 'gauge',
    help: 'Node.js process memory external bytes'
  },
  nodejs_process_cpu_usage_percentage: {
    name: 'nodejs_process_cpu_usage_percentage',
    type: 'gauge',
...
module.exports.swsEmbeddedUIMarkup =
  '<!DOCTYPE html><html><head><title>Swagger Stats UI</title><link href="dist/css/sws.min.css" rel="stylesheet"></head>\
                <body>\
                <div id="SWSUI"></div>\
